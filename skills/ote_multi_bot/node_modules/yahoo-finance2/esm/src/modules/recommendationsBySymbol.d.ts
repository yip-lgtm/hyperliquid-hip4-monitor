 ...
 * @see {@link [modules/recommendationsBySymbol] recommendationsBySymbol module} docs for examples and more.
 */
export default function recommendationsBySymbol(this: ModuleThis, query: string | string[], queryOptionsOverrides?: RecommendationsBySymbolOptions, moduleOptions?: ModuleOptionsWithValidateFalse): Promise<unknown>;
//# sourceMappingURL=recommendationsBySymbol.d.ts.map
...
const recommendationsBySymbol_schema_js_1 = __importDefault(require("./recommendationsBySymbol.schema.js"));
const definitions = (0, index_js_1.getTypedDefinitions)(recommendationsBySymbol_schema_js_1.default);

...
const quoteSummary_schema_js_1 = __importDefault(require("./quoteSummary.schema.js"));
const quoteSummary_iface_schema_js_1 = __importDefault(require("./quoteSummary-iface.schema.js"));
const optsDefinitions = (0, index_js_1.getTypedDefinitions)(quoteSummary_schema_js_1.default);
const resultsDefinitions = (0, index_js_1.getTypedDefinitions)(quoteSummary_iface_schema_js_1.default);
/**
